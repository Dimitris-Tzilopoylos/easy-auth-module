...
class Controllers {
  static async loginController(req, res) {
    try {
      ...
      return HttpAdapter.makeJsonResponse({ data, res });
    } catch (error) {
      return HttpAdapter.makeJsonResponse({ res, error });
    }
  }
  ...
  static async registerController(req, res) {
    try {
      ...
      return HttpAdapter.makeJsonResponse({ res, error: new InternalServer() });
    }
  }
  ...
  static async getMeController(req, res) {
    try {
      ...
      return HttpAdapter.makeJsonResponse({ res, error: new Forbidden() });
    }
  }
  ...
  static async refreshTokenController(req, res) {
    try {
      ...
      return HttpAdapter.makeJsonResponse({ res, error: new BadRequest() });
    }
  }
  ...
  static async resendVerificationController(req, res) {
    try {
      ...
      return HttpAdapter.makeJsonResponse({ res, data: { message: "ok" } });
    } catch (error) {
      return HttpAdapter.makeJsonResponse({ res, error });
    }
  }
